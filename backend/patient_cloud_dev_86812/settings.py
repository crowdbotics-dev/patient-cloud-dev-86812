"""
Django settings for patient_cloud_dev_86812 project.
...
ROOT_URLCONF = 'patient_cloud_dev_86812.urls'
...
WSGI_APPLICATION = 'patient_cloud_dev_86812.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_cloud_dev_86812 API",
    "DESCRIPTION": "API documentation for patient_cloud_dev_86812 App",
    "VERSION": "v1",
}
